...
export const options = [
	...
	[
		"--type <t>",
		"Backup type: history_item (restore/delete default), ui_messages, api_conversation_history, task_metadata, _index, _index.task, all (list default). _index.task is a per-task index-entry extract that restores to history_item.json; _index is the full index file backup",
	],
